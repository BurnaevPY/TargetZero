...
namespace TargetZero.Infrastructure.Postgres.Migrations
{
    ...
    [Migration("20211005154127_UpdateInnovationsWithStatuses")]
    partial class UpdateInnovationsWithStatuses
    {
            ...
            modelBuilder.Entity("TargetZero.Domain.InnovationStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 5,
                            Name = "Требует доработки заявителя"
                        },
                        new
                        {
                            Id = 6,
                            Name = "Требует дополнительного рассмотрения"
                        });
                });
